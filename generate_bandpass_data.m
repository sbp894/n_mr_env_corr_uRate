...
for modVar=1:length(allModFreq)
    ...
    for winVar= 1:length(allWindows)
        ...
        saving_Dir='/media/parida/DATAPART1/Matlab/SNRenv/n_mr_env_corr_uRate/mr_corr_OUTPUT/BP_data/';
        ...
        fName2Save=sprintf('%suRate_uR_f0_BP_%d_win_%.0fms.mat', saving_Dir, modFreq, TimeResolution*1e3);
